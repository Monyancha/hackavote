...
buf.push('>' + escape((interp = user.name) == null ? '' : interp) + '</p></li><li class="divider-vertical"></li><li><a href="/logout">Logout</a></li></ul></div></div></div></div><div class="main"></div><script>var app = app || {}\napp.data = ' + ((interp = dataJSON) == null ? '' : interp) + ' </script><script src="/javascripts/lib/require/require-min.js" data-main="/javascripts/main.js"></script>');
